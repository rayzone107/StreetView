package com.osahub.rachit.streetview.misc.autoscroll;
...
public class AutoViewPager extends ViewPager {
    ...
    public AutoViewPager(Context paramContext) {
        super(paramContext);
        init();
    }

    public AutoViewPager(Context paramContext, AttributeSet paramAttributeSet) {
    ...
    private static class MyHandler extends Handler {
        ...
        private final WeakReference<AutoViewPager> autoScrollViewPager;

        public MyHandler(AutoViewPager autoScrollViewPager) {
            this.autoScrollViewPager = new WeakReference<AutoViewPager>(autoScrollViewPager);
        }
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case SCROLL_WHAT:
                    AutoViewPager pager = this.autoScrollViewPager.get();
                    if (pager != null) {
