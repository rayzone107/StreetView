...
public class CategoryItemFragment extends BaseFragment {
    ...
    public static CategoryItemFragment newInstance(int categoryId) {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        if (mCategory.getType().equals(Helper.CATEGORY_TYPE_SPECIAL)) {
            ...
            if (mCategory.getCategoryId() == 1) {
                mLocations.setBackground(ContextCompat.getDrawable(mContext, R.drawable.background_fragment_most_popular));
            } else if (mCategory.getCategoryId() == 2) {
                mLocations.setBackground(ContextCompat.getDrawable(mContext, R.drawable.background_fragment_most_visited));
            }

            mLocations.setPadding(0, Helper.convertDpToPixel(mContext, 12), 0, Helper.convertDpToPixel(mContext, 8));
