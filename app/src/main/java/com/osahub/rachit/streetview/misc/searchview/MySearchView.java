package com.osahub.rachit.streetview.misc.searchview;
...
import static com.osahub.rachit.streetview.misc.searchview.AnimationUtil.ANIMATION_DURATION_MEDIUM;
import static com.osahub.rachit.streetview.misc.searchview.AnimationUtil.AnimationListener;
import static com.osahub.rachit.streetview.misc.searchview.AnimationUtil.fadeInView;
import static com.osahub.rachit.streetview.misc.searchview.AnimationUtil.reveal;
...
public class MySearchView extends FrameLayout {
    ...
    private void initStyle(AttributeSet attrs, int defStyleAttr) {
        ...
        if (a != null) {
            ...
            if (a.hasValue(R.styleable.MySearchView_searchVoiceIcon)) {
                setVoiceIcon(a.getDrawable(R.styleable.MySearchView_searchVoiceIcon));
            }

            if (a.hasValue(R.styleable.MySearchView_searchCloseIcon)) {
                setCloseIcon(a.getDrawable(R.styleable.MySearchView_searchCloseIcon));
            }

            if (a.hasValue(R.styleable.MySearchView_searchBackIcon)) {
                setBackIcon(a.getDrawable(R.styleable.MySearchView_searchBackIcon));
            }
    ...
    private void setVisibleWithAnimation() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            reveal(mSearchLayout, animationListener);

        } else {
            fadeInView(mSearchLayout, mAnimationDuration, animationListener);
        }
    }
